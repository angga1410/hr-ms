        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4 class="card-title text-right"> <a href="{{url('/recruitment/add-new-candidate')}}"><button class="btn btn-info" title="Add !"><i class="nc-icon nc-simple-add"></i></button> </a></h4>
                </div>
...
function refreshdata(){
   ...
   "sSearch": "Quick Search"
            ...
            columns: [
                ...
                {
                    data: 'hiring_manager_first',
                    name: 'hiring_manager_first',
                    render: function(data, type, row) {
                        return row.hiring_manager_first + '&nbsp' + row.hiring_manager_middle + '&nbsp' + row.hiring_manager_last  }
                },
                {
                    data: 'date',
                    name: 'date'
