...
<title>
        {{ __('GSPE HRM SocialNetwork') }}
    </title>
<nav class="navbar navbar-light bg-white">
   <a href="/dashboard" ><button class="btn btn-info">  < back </button></a>
<div class="logo">
        
            <div class="logo-image-small">
                <img src="{{ asset('paper') }}/img/icon.png">  {{ __('GSPE HRM') }}
            </div>
            ...
            <div class="card card-user">
                    ...
                    <div class="card-body">
                        <div class="author text-center">
                            <a href="#">
                                <img class="avatar border-gray" src="{{ asset('paper/img/mike.jpg') }}" alt="..." style="width:50%;">
