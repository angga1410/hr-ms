        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <?php } else { */ ?>
                <iframe src="{{url('http://18.141.137.82/hierarchy_modular/national_holidays_embeded')}}" width="100%" height="560" frameBorder="0" style="border:0px none;">Your browser isn't compatible</iframe>
                <?php // } ?>
